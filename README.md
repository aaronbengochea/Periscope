...
The goal of this project is to build a high performance/reliability Rust based platform enabling agentic enabled options volatility surface analysis, vol relative value identification, and deterministic programatic systematic trading. 
